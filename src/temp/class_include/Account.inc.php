...
include_once 'doado/private/models/account/bases/ARMBaseDMAccount.abstract.php';
include_once 'doado/private/models/account/bases/ARMBaseDMAccount.DAO.php';
include_once 'doado/private/models/account/DMAccount.DAO.php';
include_once 'arm/module/log/ARMLog.module.php';
include_once 'arm/module/log/ARMLogInfo.vo.php';
include_once 'doado/private/models/account/bases/ARMBaseDMAccountModule.abstract.php';
include_once 'doado/private/models/account/DMAccount.entity.php';
include_once 'doado/private/models/account/DMAccount.module.php';
include_once 'doado/private/models/account/DMAccount.vo.php';
include_once 'doado/private/models/account/DMAccountModel.gateway.php';
